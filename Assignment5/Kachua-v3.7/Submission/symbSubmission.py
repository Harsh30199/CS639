...
def checkEq(args,ir):
   ...
   ## params = list(testData['1']['symbEnc'].keys())
    ...
    ##constant parameter is satisfied by the parameter value specified in current test case. if a constarint is found, then variable name in that constraint is replaced with numeric parameter value
