...
if __name__ == '__main__':
    ...
    if False:
        ...
        for edge in cfg.edges():
            print(str(edge), cfg.get_edge_label(*edge))
    ...
    if args.SBFL:
        ...
        command : ./kachua.py --SBFL ./example/sbfl1.tl --buggy ./example/sbfl1_buggy.tl -vars '[":x", ":y", ":z"]' --timeout 1 --ntests 20 --popsize 100 --cxpb 1.0 --mutpb 1.0 --ngen 100 --verbose True
